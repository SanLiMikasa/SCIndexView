...
@property (nonatomic, strong) UIColor *indexItemsBackGroundColorWhenDrag;   // 索引元素拖动时的背景颜色
@property (nonatomic, strong) UIColor *indexItemsColorWhenDrag;             // 索引元素拖动时的文字颜色
